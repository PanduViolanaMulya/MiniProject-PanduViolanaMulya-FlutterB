...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Stack(
        children: [
          Image(image: AssetImage('assets/screen_home.gif')),
          ListView(
            children: [
              SizedBox(
                height: 35,
              ...
              Container(
                ...
                child: Text('Hello User!! Welcome To Sansuumaru'),
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: Stack(
                          children: [
                            Image(
                                image: AssetImage('assets/button_action.png')),
                            Align(
                                alignment: Alignment.center,
              ...
              CarouselSlider(items: [
                Container(
                  child: Image(
                      width: double.maxFinite,
                      fit: BoxFit.cover,
                      image: AssetImage('assets/item_event.png')),
                ...
                Container(
                  child: Image(
                      width: double.maxFinite,
                      fit: BoxFit.cover,
                      image: AssetImage('assets/item_event1.png')),
                  margin: EdgeInsets.all(5),
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(20),
                ...
                Container(
                  child: Image(
                      width: double.maxFinite,
                      fit: BoxFit.cover,
                      image: AssetImage('assets/item_event2.png')),
                  margin: EdgeInsets.all(5),
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(20),
